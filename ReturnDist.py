# -*- coding: utf-8 -*-
"""
Created on Fri Jan 10 17:33:33 2020
...
def ward_tree(X, connectivity=None, n_clusters=None, return_distance=True):
...
cluster = linkage_tree(variables, n_clusters=40, affinity='euclidean', linkage= 'complete',connectivity=None, return_distance=True)
print(cluster)